 ...
 * @Controller: This is simply a specialization of the @Component class, which allows us to
 * auto-detect implementation classes through the classpath scanning (layman's terms: let spring
 * know this thing should run when app runs)
 * @ResponseBody: This annotation enables automatic serialization of the return object into the
 * HttpResponse.
 */
@RestController
